...
export function StatusBadge({ status, className, ...props }: StatusBadgeProps) {
  ...
  const validStatuses = ["pending", "approved", "rejected", "active", "open", "present", "closed", "filled", "resolved", "absent", "expiring", "expired", "completed", "offboarding", "left", "enrolled", "published", "archived"];
