  ...
  "font-medium",
  {
    variants: {
      status: {
        ...
        filled: "bg-emerald-100 text-emerald-800 hover:bg-emerald-100/80 border-emerald-200",
        ongoing: "bg-amber-100 text-amber-800 hover:bg-amber-100/80 border-amber-200",
...
export function StatusBadge({ status, className, ...props }: StatusBadgeProps) {
  ...
  const validStatuses = ["pending", "approved", "rejected", "active", "open", "present", "closed", "filled", "resolved", "ongoing", "absent", "expiring", "expired", "completed", "offboarding", "left", "enrolled", "published", "archived"];
